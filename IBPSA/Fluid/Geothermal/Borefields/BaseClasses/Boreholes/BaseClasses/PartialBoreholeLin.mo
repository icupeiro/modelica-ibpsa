within IBPSA.Fluid.Geothermal.Borefields.BaseClasses.Boreholes.BaseClasses;
partial model PartialBoreholeLin
  ...
  parameter Modelica.SIunits.Temperature TFlu_start = TGro_start
