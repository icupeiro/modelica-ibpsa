...
model GroundTemperatureResponse_ContinuousRecordCoo
...
//  "weighting function to take only the last value of optimization";
  ...
  "Condenser heat flow";
  Modelica.SIunits.HeatFlowRate[15] Qashp(min=0)
  "ASHP heat flow";
 ...
 Modelica.Blocks.Interfaces.RealInput[15] Te(unit="K")
    "average prediction of external temperature" annotation (Placement(
        transformation(extent={{-120,-58},{-100,-38}}), iconTransformation(
...
end GroundTemperatureResponse_ContinuousRecordCoo;
