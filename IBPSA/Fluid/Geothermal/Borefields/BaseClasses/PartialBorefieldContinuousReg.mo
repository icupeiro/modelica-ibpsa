...
partial model PartialBorefieldContinuousReg
  ...
  HeatTransfer.LoadAggregation.GroundTemperatureResponse_ContinuousRecordReg
    groTemRes(
...
equation
  ...
  connect(QBor_Ext, groTemRes.Qext) annotation (Line(points={{-100,70},{-64,70},
          {-64,62},{12,62},{12,88.8},{19,88.8}},
                                             color={0,0,127}));
  connect(groTemRes.Qinj, QBor_Inj)
    annotation (Line(points={{19,87},{19,24},{-100,24}}, color={0,0,127}));
  annotation (
...
end PartialBorefieldContinuousReg;
