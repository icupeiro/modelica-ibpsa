...
function timSerMat2 "Reads and possibly writes a matrix with a time series
  of the g-function"
  ...
  input Modelica.SIunits.ThermalDiffusivity as "Thermal diffusivity of soil";
  input Modelica.SIunits.ThermalConductivity ks "Thermal conductivity of soil";
